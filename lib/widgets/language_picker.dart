          ...
          child: ListView(
            ...
            children: [
              ListTile(
                ...
                subtitle: const Text('Português • English • Español • Français • Deutsch • Italiano • हिन्दी • Bahasa Indonesia • 日本語 • 한국어 • Русский • Türkçe • 中文'),
              ),
              ...
              option(lang: AppLang.hi, label: 'हिन्दी (IN)', flag: '🇮🇳'),
              option(lang: AppLang.id, label: 'Bahasa Indonesia (ID)', flag: '🇮🇩'),
              option(lang: AppLang.ja, label: '日本語 (JP)', flag: '🇯🇵'),
              option(lang: AppLang.ko, label: '한국어 (KR)', flag: '🇰🇷'),
              option(lang: AppLang.ru, label: 'Русский (RU)', flag: '🇷🇺'),
              option(lang: AppLang.tr, label: 'Türkçe (TR)', flag: '🇹🇷'),
